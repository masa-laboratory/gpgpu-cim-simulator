...
__global__ void Sgemm( 
    ...
    do{
        ...
        //     }
        // }
        unsigned long accum_addr = (unsigned long)&accum[0];
        unsigned long As_addr = (unsigned long)&As[0];
        unsigned long Bs_addr = (unsigned long)&Bs[0];
        asm volatile ("cimma.shmma.synchro.rowmajor.colmajor.m128n128k8.f32.f32 %0, %1, %2;" : "=l"(accum_addr) : "l"(As_addr), "l"(Bs_addr));
